...
type Leaderboard = components['schemas']['Leaderboard'];
type User = components['schemas']['User'];
type LeaderboardUser = components['schemas']['LeaderboardUser'];
 ...
 */
const listLeaderboards = async (token: string): Promise<Leaderboard[]> => {
    try {
 ...
 */
const partialUpdateLeaderboard = async (
    id: number,
    leaderboard: Partial<Leaderboard>,
    token: string,
): Promise<Leaderboard> => {
    try {
        const response = await apiClient.patch<Leaderboard>(
            `/api/v1/leaderboard/${id}/`,
            leaderboard,
            {
                headers: {
 ...
 */
const deleteLeaderboard = async (id: number, token: string): Promise<void> => {
    try {
...
const createLeaderboardUser = async (
    ...
    try {
        const response = await apiClient.post<LeaderboardUser>(
            '/api/v1/leaderboard/user/',
            { leaderboard, user },
            {
                headers: {
 ...
 */
const listUserLeaderboards = async (
    userId: number,
    token: string,
): Promise<Leaderboard[]> => {
    try {
        const response = await apiClient.get<Leaderboard[]>(
            `/api/v1/user/${userId}/leaderboards/`,
            {
                headers: { Authorization: `Bearer ${token}` },
            },
        );
 ...
 */
const retrieveSpecificUserLeaderboard = async (
    userId: number,
    leaderboardId: number,
    token: string,
): Promise<Leaderboard> => {
    try {
        const response = await apiClient.get<Leaderboard>(
            `/api/v1/user/${userId}/leaderboard/${leaderboardId}/`,
            {
                headers: { Authorization: `Bearer ${token}` },
            },
        );
 ...
 */
const partialUpdateSpecificUserLeaderboard = async (
    userId: number,
    leaderboardId: number,
    leaderboardUser: Partial<LeaderboardUser>,
    token: string,
): Promise<LeaderboardUser> => {
    try {
        const response = await apiClient.patch<LeaderboardUser>(
            `/api/v1/user/${userId}/leaderboard/${leaderboardId}/`,
            leaderboardUser,
            {
                headers: {
 ...
 */
const destroySpecificUserLeaderboard = async (
    userId: number,
    leaderboardId: number,
    token: string,
): Promise<void> => {
