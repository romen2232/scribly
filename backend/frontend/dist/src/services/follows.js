 ...
 */
const listUserFollowers = async (userId, token) => {
    try {
        const response = await apiClient.get(`/api/v1/follows/${userId}/followers/`, {
 ...
 */
const listUserFollowings = async (userId, token) => {
    try {
        const response = await apiClient.get(`/api/v1/follows/${userId}/following/`, {
            headers: { Authorization: `Bearer ${token}` },
        });
        return response.data;
    }
 ...
 */
const retrieveFollow = async (followerId, followedId, token) => {
    try {
        const response = await apiClient.get(`/api/v1/follows/${followerId}/follow/${followedId}/`, {
            headers: { Authorization: `Bearer ${token}` },
        });
        return response.data;
    }
 ...
 * @returns void
 */
const destroyFollow = async (followerId, followedId, token) => {
    try {
        await apiClient.delete(`/api/v1/follows/${followerId}/unfollow/${followedId}/`, {
            headers: { Authorization: `Bearer ${token}` },
        });
    }
    catch (error) {
 ...
 */
const retrieveUserFriends = async (userId, token) => {
    try {
 ...
 */
const listFollows = async (token) => {
    try {
        const response = await apiClient.get('/api/v1/follows/', {
            headers: { Authorization: `Bearer ${token}` },
        });
        return response.data;
    }
 ...
 */
const createFollow = async (follower, followed, token) => {
    try {
        const response = await apiClient.post('/api/v1/follows/', { follower, followed }, {
            headers: { Authorization: `Bearer ${token}` },
        });
        return response.data;
    }
...
const notFollowing = async (userId, token) => {
    try {
        const response = await apiClient.get(`api/v1/follows/notFollowing/${userId}/`, {
            headers: { Authorization: `Bearer ${token}` },
        });
        return response.data;
    }
...
export { listUserFollowers, listUserFollowings, retrieveFollow, destroyFollow, retrieveUserFriends, listFollows, createFollow, notFollowing };
