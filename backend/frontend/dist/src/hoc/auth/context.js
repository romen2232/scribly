...
import { AUTH_COOKIE_NAME, REFRESH_COOKIE_NAME, USER_COOKIE_NAME, } from '../../utils/consts';
import { retrieveUser, loginUser, registerUser, activateUser, } from '../../services/auth';
...
export const AuthProvider = ({ children }) => {
    ...
    const registerFunction = useCallback(async ({ email, password, username }) => {
        setLoading(true);
    ...
    const activateUserReact = async (token) => {
        setLoading(true);
        try {
