...
class TasksUserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Tasks_users
        fields = ['task', 'user', 'task_date', 'earned_points', 'answer_note',
                  'answer_text', 'answer_boolean', 'is_completed', 'response_text']
...
class LessonsUsersSerializerWithTaskUser(serializers.ModelSerializer):
    ...
    class Meta:
        model = Lessons_users
        fields = ['id', 'percentage_completed',
                  'lesson_start_date', 'lesson', 'user', 'task_user']
    ...
    def get_task_user(self, obj):
        ...
        serialized_task_users = TasksUserSerializer(
